...
const DetailProductOrderPayback = ({ product_id, handleClose, open }: Props) => {
                    ...
                    return (
                      <TableRow hover tabIndex={-1} key={`${row.id}`}>
                        ...
                        <TableCell align="right">
                          ...
                          >
                            <p style={{ fontSize: 10 }}>Thêm vào danh sách thay đổi</p>
                          </Button>
                        </TableCell>
                      </TableRow>
                    );
...
export default DetailProductOrderPayback;
